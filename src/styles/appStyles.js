...
export const S = {
  ...
  inputClearBtn: { position: "absolute", right: 8, bottom: 8, zIndex: 3, width: 26, height: 26, borderRadius: 13, border: "1px solid rgba(239,68,68,0.55)", background: "rgba(69,10,10,0.82)", color: "#fca5a5", fontFamily: mono, fontSize: 13, lineHeight: 1, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", padding: 0 },
  ...
  imageSizeHeadRow: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 6 },
  promptExtendToggle: { display: "inline-flex", alignItems: "center", gap: 6, color: "#a1a1aa", fontFamily: mono, fontSize: 11, cursor: "pointer", whiteSpace: "nowrap" },
  promptExtendModeSelect: { height: 26, padding: "2px 5px", borderRadius: 6, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(255,255,255,0.04)", color: "#e4e4e7", fontFamily: mono, fontSize: 10, outline: "none" },
  ...
  viewerInfoPanel: { position: "absolute", top: 52, right: 16, zIndex: 15, width: "min(360px, calc(100% - 32px))", maxHeight: "min(72vh, 620px)", overflow: "auto", borderRadius: 10, border: "1px solid rgba(255,255,255,0.18)", background: "rgba(15,17,21,0.95)", color: "#f8fafc", boxShadow: "0 18px 50px rgba(0,0,0,0.42)", padding: "12px 14px", display: "grid", gap: 10 },
  viewerInfoPanelDocked: { flex: "0 0 320px", width: 320, height: "100%", minHeight: 0, overflow: "hidden", alignSelf: "stretch", borderRadius: 10, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(15,17,21,0.96)", color: "#f8fafc", boxShadow: "0 18px 50px rgba(0,0,0,0.4)", padding: "16px 16px", display: "flex", flexDirection: "column", gap: 12 },
  viewerInfoHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 },
  viewerInfoTitle: { fontFamily: mono, fontSize: 11, textTransform: "uppercase", letterSpacing: 0.6, color: "#a1a1aa" },
  viewerInfoClose: { width: 22, height: 22, borderRadius: 11, border: "1px solid rgba(255,255,255,0.16)", background: "transparent", color: "#e2e8f0", fontSize: 12, lineHeight: 1, cursor: "pointer", display: "inline-flex", alignItems: "center", justifyContent: "center", padding: 0 },
  viewerInfoRows: { display: "grid", gap: 6 },
  viewerInfoRow: { display: "grid", gridTemplateColumns: "84px minmax(0, 1fr)", gap: 10, alignItems: "baseline" },
  viewerInfoLabel: { fontFamily: mono, fontSize: 11, color: "#a1a1aa", whiteSpace: "nowrap" },
  viewerInfoValue: { fontFamily: mono, fontSize: 12, color: "#f1f5f9", wordBreak: "break-word", minWidth: 0 },
  viewerInfoPromptWrap: { display: "grid", gap: 6, borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 10 },
  viewerInfoPromptHead: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 },
  viewerInfoCopyBtn: { height: 24, padding: "0 10px", borderRadius: 999, border: `1px solid ${THEME_EMERALD_BORDER}`, background: THEME_EMERALD_SOFT, color: THEME_EMERALD_TEXT, fontFamily: mono, fontSize: 11, cursor: "pointer", display: "inline-flex", alignItems: "center", flexShrink: 0 },
  viewerInfoPromptText: { maxHeight: 220, overflow: "auto", fontFamily: mono, fontSize: 12, lineHeight: 1.55, color: "#e2e8f0", whiteSpace: "pre-wrap", wordBreak: "break-word", background: "rgba(2,6,23,0.5)", borderRadius: 8, padding: "8px 10px" },
  viewerInfoPromptWrapDocked: { display: "flex", flexDirection: "column", gap: 6, flex: 1, minHeight: 0, borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 10 },
  viewerInfoPromptTextDocked: { flex: 1, minHeight: 0, overflow: "auto", fontFamily: mono, fontSize: 12, lineHeight: 1.55, color: "#e2e8f0", whiteSpace: "pre-wrap", wordBreak: "break-word", background: "rgba(2,6,23,0.5)", borderRadius: 8, padding: "8px 10px" },
