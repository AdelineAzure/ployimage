...
export const S = {
  ...
  viewerInfoPanelDocked: { flex: "0 0 320px", width: 320, height: "100%", overflow: "auto", alignSelf: "stretch", borderRadius: 10, border: "1px solid rgba(255,255,255,0.14)", background: "rgba(15,17,21,0.96)", color: "#f8fafc", boxShadow: "0 18px 50px rgba(0,0,0,0.4)", padding: "16px 16px", display: "grid", gap: 12, alignContent: "start" },
